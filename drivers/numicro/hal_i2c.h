 ...
 */
/*
   Modified and adopted for Nuvoton NuMicro Family support by Ein Terakawa.
 */
...
#define osalDbgCheck(x)
#define osalDbgAssert(x,y)
#define osalSysLock()
 ...
 * @notapi
 */
#define _i2c_wakeup_isr(i2cp) do { (i2cp)->thread = MSG_OK; } while(0)
 ...
 * @notapi
 */
#define _i2c_wakeup_error_isr(i2cp) do { (i2cp)->thread = MSG_RESET; } while(0)
