...
MO(1), MO(2), KC_LGUI, KC_LALT, KC_SPC, KC_INT4, KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT \
	 ),
  LAYOUT(
...
_______, _______, _______, KC_DEL, KC_ENT, KC_CLCK, KC_NLCK, KC_SLCK, RGB_TOG, KC_VOLD, KC_MPLY \
  ...
  LAYOUT(
KC_LGUI, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_INS, KC_DEL, KC_PSCR,\
KC_APP, _______, _______, _______, RESET,   _______, INSERT,  KC_HOME, KC_PGUP, KC_PGDN, KC_END, SCTL(KC_2), LSFT(KC_INS), _______, _______, \
...
_______, MO(2), _______, _______, _______, _______, _______, _______, _______, _______, _______ \
	 )
};
